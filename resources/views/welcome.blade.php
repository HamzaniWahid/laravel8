                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                                ...
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    <div class="flex items-center space-x-4 text-gray-600">
                                        <div class="bg-green-50 p-2 rounded-lg border border-green-200">
                                            <p class="text-sm ">Total Pemesanan</p>
                                            <p class="text-lg">
                                                {{$totalInventories}}
                                            </p>
                                        </div>
                                        ...
                                        <div class="bg-rose-50 p-2 rounded-lg border border-rose-200">
                                            <p class="text-sm ">Total Stok < 10</p>
                                            <p class="text-lg">
                                                {{$totalExpired}}
                                            </p>
                                        </div>
                        ...
                        <a href="{{url('/admin')}}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Inventori</h2>
                                ...
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    <div class="flex items-center space-x-4 text-gray-600">
                                        ...
                                        <div class="bg-amber-50 p-2 rounded-lg border border-amber-200">
                                            <p class="text-sm ">Total Hampir Expired</p>
                                            <p class="text-lg">
                                                {{$almostExpired}}
                                            </p>
                                        </div>
                                        <div class="bg-rose-50 p-2 rounded-lg border border-rose-200">
                                            <p class="text-sm ">Total Expired</p>
                                            <p class="text-lg">
                                                {{$totalExpired}}
                                            </p>
                                        </div>
